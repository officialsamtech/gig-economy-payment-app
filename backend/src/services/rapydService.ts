...
class RapydService {
    ...
    public async createBeneficiary(body: Beneficiary): Promise<any> {
        ...
        try {
            const response = await this._axiosClient.post('/v1/payouts/beneficiary', body);
    ...
    public async getBeneficiaries(beneficiaryId: string): Promise<Beneficiary[]> {
        try {
            const response = await this._axiosClient.get(`/v1/payouts/beneficiary/${beneficiaryId}`);
            return response.data;
        } catch (error) {
            if (error.isAxiosError) {
    ...
    public async createPayout(body: Payout): Promise<any> {
        ...
        try {
            const response = await this._axiosClient.post('/v1/payouts', body);
    ...
    public async getPayoutMethodTypes(payout_currency: string): Promise<PayoutMethod[]> {
        try {
            const response = await this._axiosClient.get(`/v1/payouts/supported_types?payout_currency=${payout_currency}`);
            return response.data;
        } catch (error) {
            if (error.isAxiosError) {
                throw new HttpException(+error.response.status, error.response.data?.status || error.response.data);
    ...
    public async getPayouts(): Promise<Payout[]> {
        try {
            const response = await this._axiosClient.get('/v1/payouts');
            return response.data.data; // Assuming the API returns the list of payouts in a 'data' field
        } catch (error) {
            if (error.isAxiosError) {
                // Handle the error based on your application's requirements
                throw new HttpException(+error.response.status, error.response.data?.status || error.response.data);
    ...
    public async getPayout(payoutId: string): Promise<Payout> {
        try {
            const response = await this._axiosClient.get(`/v1/payouts/${payoutId}`);
            return response.data;
        } catch (error) {
            if (error.isAxiosError) {
                throw new HttpException(+error.response.status, error.response.data?.status || error.response.data);
    ...
    public async confirmPayout(payoutId: string): Promise<any> {
        try {
            const response = await this._axiosClient.post(`/v1/payouts/confirm/${payoutId}`);
            return response.data;
        } catch (error) {
            if (error.isAxiosError) {
                throw new HttpException(+error.response.status, error.response.data?.status || error.response.data);
    ...
    public async cancelPayout(payoutId: string): Promise<any> {
        try {
            const response = await this._axiosClient.delete(`/v1/payouts/cancel/${payoutId}`);
            return response.data;
        } catch (error) {
            if (error.isAxiosError) {
                throw new HttpException(+error.response.status, error.response.data?.status || error.response.data);
